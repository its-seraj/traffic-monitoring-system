<div class="col-sm-12">
    ...
    <div class="card-body">
      ...
      <form action="<?= base_url("thana/add_thana")?>" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-sm-6">
...
<script type="text/javascript">
  $(function(){
    $('select[name="stuBranch"]').on('change',function(){
    //  alert($(this).val());
        $.ajax({
          ...
          success:function(res){
             ...
             semvalue ='<option value="">Select Any One</option>';
             for (var i = 1; i <= snumber; i++) {
                  semvalue = semvalue + '<option value="'+i+'">'+i+'</option>';
             }
              $('select[name="stuSemester"]').html(semvalue);
          }
       });
    });
  });
...
<script type="text/javascript">
      ...
      function checkEmail(a)
      {
         ...
         if(email!='')
         $.ajax({
            url: '<?=  site_url("teacher/check_email"); ?>',
